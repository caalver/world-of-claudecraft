...
import type {
  BuildingDef, CampDef, GroundObjectDef, ItemDef, MobTemplate, NpcDef, PlayerClass, QuestDef, ZoneDef, ZonePropsDef,
} from '../types';
...
export const ZONE2_ZONE: ZoneDef = {
  ...
  lakes: [
    ...
    { x: 388, z: 512, radius: 32 }, // Mirrorfen Basin — Aldermere city lake
  ],
  pois: [
...
export const ZONE2_ROADS: { x: number; z: number }[][] = [
  ...
  [{ x: -80, z: 420 }, { x: -20, z: 424 }, { x: 40, z: 428 }, { x: 100, z: 430 },
    { x: 148, z: 432 }, { x: 172, z: 433 }],
  // Tree-lined Kingsroad Boulevard — long approach from the pass into Aldermere
...
export const ZONE2_NPCS: Record<string, NpcDef> = {
  warden_fenwick: {
    ...
    pos: { x: 3, z: 304 }, facing: 3.142, color: 0x7e5109,
  ...
  provisioner_hale: {
    ...
    pos: { x: -4, z: 308 }, facing: 1.571, color: 0x1e8449,
  ...
  herbalist_yara: {
    ...
    pos: { x: 10, z: 295 }, facing: -1.571, color: 0x7d3c98,
...
// @zone-editor-begin ZONE2_PROPS
export const ZONE2_PROPS: ZonePropsDef = {
  buildings: [
    { kind: 'inn', x: 13, z: 306, w: 12, d: 14, rot: -1 },
